...
describe('LayerManager', () => {
  ...
  describe('Create a new transit layer', () => {
    it(
        'should call mapsApiWrapper when creating a new transit layer',
        fakeAsync(
            inject(
  ...
  describe('Create a new bicycling layer', () => {
    it(
        'should call mapsApiWrapper when creating a new bicycling layer',
        fakeAsync(
            inject(
                [LayerManager, GoogleMapsAPIWrapper],
                (layerManager: LayerManager, apiWrapper: GoogleMapsAPIWrapper) => {
       ...
       fakeAsync(
           ...
           inject(
               ...
               (layerManager: LayerManager, apiWrapper: GoogleMapsAPIWrapper) => {
                 ...
                 (apiWrapper.createTransitLayer as jest.Mock)
                     .mockReturnValue(
